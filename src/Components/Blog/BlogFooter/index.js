                ...
                <div className="container blogfooter-container">
                    <div className="row main-row">
                        <div className="col-lg-6 left-area">
                            ...
                            <p>Only 1-on-1 Pay As You Go Online Tutoring With U.S Based Tutors In All Subjects & Test Prep</p>
                            <div className="form-area">
                                <div className="email-area">
                                    ...
                                    <div className="explain">Over 10,000 verified and background checks U.S tutors ready to work with you</div>
                                </div>
                            </div>
                        </div>
